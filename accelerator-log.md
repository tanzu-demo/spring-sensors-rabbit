...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/tanzu-demo/spring-sensors-rabbit.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "gcr.io/cf-sandbox-trisberg/spring-sensors-publisher",
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->gcr.io/cf-sandbox-tr...(truncated)]
